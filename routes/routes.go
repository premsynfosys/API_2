...
func ConsumableRoutings(r *mux.Router, Handler *cnsmblhndlr.IConsumableRepo) {
	r.HandleFunc("/Consumables/BulkCreate", utils.IsAuthorized(Handler.BulkCreateConsumables))
...
func NonITAssetRouting(r *mux.Router, pHandler *nonitassetshndlr.INonITAsset) {
	...
	r.HandleFunc("/NonITAsset/BulkCreateNonITAsset", utils.IsAuthorized(pHandler.BulkCreateNonITAsset))
